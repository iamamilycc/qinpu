...
(function () {
  ...
  window.loadDemo2 = function () {
    ...
    if ($('selTuning')) { $('selTuning').value = 'zheng'; $('selTuning').dispatchEvent(new Event('change')); }
    if ($('selArrProfile')) $('selArrProfile').value = 'qinge';
    setArrProfile('qinge');
    // 2026-07-18 用户逐音闭环（琴书四行谱：五线谱+简谱+减字，梅庵查阜西本）——
    //   核心勘误：泛音○全曲逐音标（原网络转写全漏）；系统3「胡窥青海湾」整段泛音、
    //   系统1「苍茫/云海」+系统2「吹度玉门关」零星泛音；八度以五线谱为准逐音核。
    $('inJianpu').value =
      "2/4 |: 5,. 6,_ 1 1 | 1. 2_ | 5 (555) 6 [fan 2 ]fan | [fan 5 ]fan - / " +
      "1' 2' 2' 1'6 5 5 | [fan 2'. 3' 5' 5' ]fan | 1'. 6_ 1' 6 | 5 1' 6 5 | 5 3 5 / " +
      "[fan 5 (666) 5 (666) | 5. 32. 3 | 5 5 ]fan | 1' (666)5 1' 6 5 / " +
