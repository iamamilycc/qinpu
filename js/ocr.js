...
(function () {
  ...
  var PROMPT =
    ...
    '②减字列数可少于简谱音数：走音/撞/退复/進復是一弹多音，后续音只在简谱行有数字；' +
    '③孤立的裸弦号（如单个"四"）=承前简省：沿用前一字的指法（左手按位若仍在也一并沿用）；' +
    '④减字右侧小字为技法串（自上而下）：上/下+徽位=走音，隹=進 艮=退（可带目标徽分） 白=復 立=撞；' +
    '⑤转录简谱时逐个确认高低八度点，勿凭旋律惯性补八度。';
